...
/** The official multi-color Google "G" mark (inline, no asset request). */
...
/**
 * "Continue with Google" entry point. Rendered only when the Google OAuth
 * enable flag is set — the actual OAuth round trip runs against the backend.
 */
